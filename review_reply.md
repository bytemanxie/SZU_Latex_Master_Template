...
4. DeepSeek-V3 实验中内存占用较大、精度提升不明显，需要解释原因。
...
5. 参考文献中 arXiv 文献较多，近三年正式发表文献偏少。

答：会重新筛选参考文献，减少预印本文献比例，补充近三年正式发表的期刊、会议论文和相关代表性工作。

6. 图像重建与语义分割之间的关系不够明确。
...
13. 第二章中基础网络介绍过多，部分图可以删减。

答：会压缩基础网络介绍，删除与本文创新点关系不大的基础结构图，把篇幅更多放在本文方法设计和改进部分。

14. CUDA、GPU 与实验性能之间的关系需要说清楚。
