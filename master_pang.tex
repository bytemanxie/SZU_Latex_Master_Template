...
\renewcommand{\titleCN}{激光焊接OCT图像重建与语义分割方法研究}
\renewcommand{\titleEN}{Research on OCT Image Reconstruction and Semantic Segmentation for Laser Welding}
...
%封面 自行配置生成pdf文件导入即可
\includepdf[pages={1,2}]{深圳大学研究生学位论文格式模板（专业学位硕士）.docx.pdf}
